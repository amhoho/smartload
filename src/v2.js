...
var me=this,index;
if(!me['is_'+type](value)){me.log('统一配置错误:',value);return false;};
if(!v_type){return true;};
if(me.is_object(value)||me.is_array(value)){for(var index in value) {if(!me['is_'+v_type](value[index])){me.log('统一配置错误:',index);return false;};};}
return true;
}
//取出cmd所有的key
...
var returns,
returns=/^((http|https):\/\/)[\w-_.]+(\/[\w-_]+)*\/?$/.exec(variable);
